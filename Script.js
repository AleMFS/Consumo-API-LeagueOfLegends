...
function loadChampions() {
    ...
    fetch('http://ddragon.leagueoflegends.com/cdn/12.11.1/data/pt_BR/champion.json')
...
function montarLista(lista) {
    ...
    for (let i = 0; i < dados.length; i++) {
        ...
        champion.style.backgroundImage = `url( 'http://ddragon.leagueoflegends.com/cdn/12.11.1/img/champion/${dados[i][1].id}.png')`;
...
area.addEventListener('click', (event) => {
    ...
    fetch(`http://ddragon.leagueoflegends.com/cdn/12.11.1/data/pt_BR/champion/${event.target.classList[2]}.json`)
    .then(function (resultado) {
        return resultado.json();
    })
    .then(function (json) {
